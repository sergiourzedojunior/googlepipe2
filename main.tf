...
module "bucket-raw" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-suj-raw"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-curated" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-suj-curated"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-tmp" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-pyspark-suj-tmp"
  project_id = var.project_id
  location   = var.region
}
...
module "bucket-pyspark-code" {
  ...
  name       = "data-pipeline-stack-combustiveis-brasil-pyspark-suj-code"
  project_id = var.project_id
  location   = var.region
}